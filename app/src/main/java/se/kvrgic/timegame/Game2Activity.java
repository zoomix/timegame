...
public class Game2Activity extends Activity {
    ...
    public static final String GAMESTORE = "score_game2";
    public static final String BESTGAMESTORE = "bestscore_game2";
    ...
    private void doSetupGame() {
        ...
        gameState.correctAnswer = new Answer( Math.round(Math.random() * 12), Math.round(Math.floor(Math.random() * 4)) * 15);
        gameState.answers.add(gameState.correctAnswer);
        while (gameState.answers.size() < 3) {
            Answer alternativeAnswer = new Answer(Math.round(Math.random() * 12), Math.round(Math.floor(Math.random() * 4)) * 15);
